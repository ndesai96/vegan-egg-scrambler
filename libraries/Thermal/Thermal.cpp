// Adapted from the Adafruit AMG88xx library to streamline library to only required functions.
...
*/
/**************************************************************************/
bool IRCamera::begin(uint8_t addr)
{
	_i2caddr = addr;
...
*/
/**************************************************************************/
// void IRCamera::setMovingAverageMode(bool mode)
// {
// 	_ave.MAMOD = mode;
...
*/
/**************************************************************************/
// void IRCamera::setInterruptLevels(float high, float low)
// {
...
*/
/**************************************************************************/
// void IRCamera::setInterruptLevels(float high, float low, float hysteresis)
// {
...
*/
/**************************************************************************/
void IRCamera::disableInterrupt()
{
	_intc.INTEN = 0;
	this->write8(AMG88xx_INTC, _intc.get());
}
...
*/
/**************************************************************************/
// void IRCamera::setInterruptMode(uint8_t mode)
// {
// 	_intc.INTMOD = mode;
// 	this->write8(AMG88xx_INTC, _intc.get());
// }
...
*/
/**************************************************************************/
// void IRCamera::getInterrupt(uint8_t *buf, uint8_t size)
// {
...
*/
/**************************************************************************/
void IRCamera::readPixels(float *buf, uint8_t size)
{
	uint16_t recast;
	float converted;
...
*/
/**************************************************************************/
void IRCamera::write8(byte reg, byte value)
{
...
*/
/**************************************************************************/
// uint8_t IRCamera::read8(byte reg)
// {
// 	uint8_t ret;
// 	this->read(reg, &ret, 1);
//
...
// }
//
void IRCamera::_i2c_init()
{
	Wire.begin();
}

void IRCamera::read(uint8_t reg, uint8_t *buf, uint8_t num)
{
	uint8_t value;
	uint8_t pos = 0;
...
void IRCamera::write(uint8_t reg, uint8_t *buf, uint8_t num)
{
#ifdef I2C_DEBUG
...
*/
/**************************************************************************/
float IRCamera::signedMag12ToFloat(uint16_t val)
{
